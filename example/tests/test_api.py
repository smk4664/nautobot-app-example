...
class ExampleExampleModelAPIViewTest(APIViewTestCases.APIViewTestCase):
    # pylint: disable=too-many-ancestors
    """Test the API viewsets for ExampleExampleModel."""
    ...
    def setUpTestData(cls):
        """Create test data for ExampleExampleModel API viewset."""
        super().setUpTestData()
